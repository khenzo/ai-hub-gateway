...
**Layer 3 — Agent Identity (Agent 365)** transforms agents into enterprise assets with **unique identities, lifecycle management, and access controls**. Built on **Microsoft Entra ID**, this layer addresses shadow AI and enables scale with trust by ensuring no agent operates anonymously at scale.
...
```mermaid
graph TB
    A["Agent A (Finance)<br/>Object ID · Sponsor · Access Package"]
    B["Agent B (Sales)<br/>Object ID · Sponsor · Access Package"]
    C["Agent C (Support)<br/>Object ID · Sponsor · Access Package"]
    EID["Microsoft Entra ID<br/>Service Principals · Access Policies · Lifecycle Workflows"]
    GC["Governance &amp; Compliance<br/>Access Reviews · Audit Logs · Compliance Reports"]
...
- [Agent Lifecycle Management](/operations/runbooks/index)
...
- Review [compliance monitoring](/operations/monitoring) capabilities
