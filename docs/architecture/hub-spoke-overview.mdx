...
description: 'Understand the hub-spoke architecture of the AI+ Governance Platform, including the central governance layer and connected agent spokes'
icon: network-wired
---

# Hub-Spoke Architecture Overview

The **AI+ Governance Platform** implements a **hub-spoke architecture** that provides centralized governance while enabling distributed AI development across your organization. This pattern aligns with Microsoft's Azure Landing Zone architecture and supports enterprise-scale AI governance.
