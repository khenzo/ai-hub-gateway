...
description: 'Understand the hub-spoke architecture of the SOF1A 2.0 AI Governance Platform, including the central governance layer and connected agent spokes'
icon: network-wired
---

# Hub-Spoke Architecture Overview

The **SOF1A 2.0 AI Governance Platform** implements a **hub-spoke architecture** that provides centralized governance while enabling distributed AI development across your organization. This pattern aligns with Microsoft's Azure Landing Zone architecture and supports enterprise-scale AI governance.
...
graph TB
    subgraph CGH["Central Governance Hub (CGH)"]
        ...
        OB["Observability\nUsage · Cost Attribution · Audit Logs"]
    end
...
- [Network Approach Guide](/guides/ai-landing-zone/network-approach) - Implementation guidance
