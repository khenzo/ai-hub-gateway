...
├─────────────────────────────────────────────────────────────┤
│  Platform Metrics:                                          │
│  • Overall usage: 15,000 requests                           │
│  • Token consumption: 4.2M tokens (~£180)                   │
│  • Average latency: 1.5s                                    │
│  • Uptime: 99.2%                                            │
├─────────────────────────────────────────────────────────────┤
│  Agent-Specific:                                            │
│  • Sales Q&A Bot: 1.8s avg, 2 safety flags                  │
│  • Legal Analyzer: 2.1s avg, 0 issues                       │
│  • HR Assistant: 1.4s avg, 1 alert                          │
└─────────────────────────────────────────────────────────────┘
```
...
- Explore [AI Evaluations](../operations/ai-evaluations) for quality assurance
