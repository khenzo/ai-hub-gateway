...
**Layer 2 — AI Control Plane** provides the **observability and compliance brain** of the AI+ Governance Platform. Powered by **Microsoft Foundry Control Plane**, this layer continuously evaluates agent behavior, captures end-to-end traces, runs automated red-teaming, and powers fleet operations dashboards—turning raw telemetry from every spoke into actionable governance insights.
