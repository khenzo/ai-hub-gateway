---
title: "4-Layer Architecture Model"
description: "Comprehensive overview of the SOF1A 2.0 AI Governance Platform's layered security architecture for enterprise AI governance"
icon: sitemap
---
...
The **SOF1A 2.0 AI Governance Platform** implements a unified, layered approach to AI security and governance. This architecture enables enterprises to scale AI innovation while maintaining trust, security, and regulatory compliance through **separation of concerns with unified oversight**.

## Platform Vision

The 4-layer model is the architectural blueprint of the SOF1A 2.0 AI Governance Platform. It unifies AI Landing Zone workloads and Citadel governance into a single, coherent enterprise platform. Each layer owns a distinct governance responsibility, yet all layers interlock to deliver end-to-end trust across both secure workload environments and centralized governance controls.
...
## Relationship Agent Factory

Citadel provides the **governance and security foundation** for  Agent Factory deployments. The Agent Factory brings together intelligence layers, builder platforms, and governance capabilities into a unified operating model for enterprise AI agents.
