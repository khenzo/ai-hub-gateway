...
```
Security Signals Across Layers:

Layer 1 (Gateway) ──┐
                    ├──→ Security Fabric ──→ Unified Response
Layer 2 (Control) ──┤    (Defender/Purview/Entra)
                    │
Layer 3 (Identity) ─┤         │
                    │         ▼
Layer 4 (Security) ─┘    Coordinated Action
                              │
         ┌────────────────────┼────────────────────┐
         │                    │                    │
         ▼                    ▼                    ▼
    Block Threat       Apply Policy         Revoke Access
```
...
- Learn about [security monitoring](../operations/security-monitoring)
- Explore [compliance automation](../operations/compliance-automation)
