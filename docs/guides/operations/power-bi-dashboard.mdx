...
- Insert initial data into the model-pricing container (sample data for the model-pricing container can be found in the <a href="/src/usage-reports/model-pricing.json" target="_blank">model-pricing.json</a>).
...
Now you can open the <a href="/src/usage-reports/AI-Hub-Gateway-Usage-Report-v1-5-Incremetal.pbix" target="_blank">AI-Hub-Gateway-Usage-Report-v1-5-Incremetal.pbix</a> file in the Power BI Desktop application.
