...
Leverage deployment parameter files (<a href="/bicep/infra/main.bicepparam" target="_blank">main.bicepparam</a>) to capture these decisions for each environment.
...
|------|---------|----------|
| <a href="/bicep/infra/main.bicepparam" target="_blank">main.bicepparam</a> | Environment variables | Used in azd deployments, CI/CD (Default values come from here) |
| <a href="/bicep/infra/main.parameters.dev.bicepparam" target="_blank">main.parameters.dev.bicepparam</a> | Development | Dev/test environments |
| <a href="/bicep/infra/main.parameters.prod.bicepparam" target="_blank">main.parameters.prod.bicepparam</a> | Production | Production workloads |
| <a href="/bicep/infra/main.parameters.complete.bicepparam" target="_blank">main.parameters.complete.bicepparam</a> | Reference | All parameters documented |
