...
For quick non-production deployments, see the [Quick Start](/guides/deployment/quick-start) guide.
...
Detailed networking guide: [Network Architecture](/guides/architecture/networking)
...
Guide: [Entra ID Authentication](/guides/reference/entraid-auth)
...
See [Testing Tools](/guides/development/testing-tools) for details on running validation notebooks.
...
<CardGroup cols={2}>
  <Card title="Enable Security" icon="shield-halved">
    - [Entra ID Authentication](/guides/reference/entraid-auth)
    - [PII Detection](/guides/features/pii-masking)
  </Card>
  <Card title="Set Up Monitoring" icon="chart-line">
    - [Power BI Dashboard](/guides/operations/power-bi-dashboard)
    - [Usage Analytics](/guides/operations/usage-analytics)
    - [Alert Configuration](/guides/features/throttling-handling)
  </Card>
  <Card title="Validate & Test" icon="vial" href="/guides/development/testing-tools">
    - 🧪 Run validation notebooks
    - ✅ Test backend connectivity
    - 📊 Verify usage logging
  </Card>
  <Card title="Deploy LLM Backends" icon="plug">
    - [Onboard Existing LLMs](/guides/features/llm-backend-onboarding)
    - [LLM Routing Architecture](/guides/architecture/llm-routing)
  </Card>
</CardGroup>
