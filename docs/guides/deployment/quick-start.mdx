...
This guide provides the fastest path to deploying AI Citadel Governance Hub for **development and testing environments**. For production deployments, see the [Full Deployment](/guides/deployment/full-deployment) guide.
...
<CardGroup cols={2}>
  ...
  <Card title="For Production" icon="server" href="/guides/deployment/full-deployment">
    - 📘 Full Deployment Guide
  </Card>
  <Card title="Testing & Validation" icon="vial" href="/guides/development/testing-tools">
    - 🧪 Run validation notebooks
    - ✅ Test deployed resources
  </Card>
  <Card title="Operational Scripts" icon="terminal" href="/guides/operations/scripts-reference">
