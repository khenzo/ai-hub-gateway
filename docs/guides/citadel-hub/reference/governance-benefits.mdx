...
description: "Business value and ROI analysis for Citadel Governance Hub adoption"
---
...
<Note>
For deployment and repo structure, see the main [README](https://github.com/Azure-Samples/ai-hub-gateway-solution-accelerator/tree/citadel-v1).  
For implementation guidance, start with the [Quick Start](/guides/citadel-hub/deployment/quick-start) or [Full Deployment](/guides/citadel-hub/deployment/full-deployment).
</Note>
...
<AccordionGroup>
  <Accordion title="Enterprise AI Governance">
...
- Enforce safety guardrails across agent interactions
  ...
  <Accordion title="Multi-Cloud AI Strategy">
...
- PII detection and anonymization
  ...
  <Accordion title="AI Operations at Scale">
...
<CardGroup cols={3}>
  ...
  <Card title="Business Value" icon="chart-line" href="/business-value">
