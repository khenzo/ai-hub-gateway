...
![Cosmos DB Firewall](/images/cosmos-db-firwall.png) 
...
![Insert Data](/images/cosmos-db-model-pricing.png)
...
![Transform Data](/images/power-bi-data-source-transform.png)

2. Right click on the "ai-usage-container" data table and select "Advanced Editor".

![Edit Data](/images/power-bi-data-source-adv-editor.png)

3. Replace the Cosmos DB endpoint with the one you have deployed.

![Edit Data AI Usage](/images/power-bi-data-source-adv-editor-update.png)

4. Repeat the same for model-pricing data table.

![Edit Data Model Pricing](/images/power-bi-data-source-adv-editor-update2.png)
...
![Power BI Dashboard](/images/power-bi-data-final.png)
